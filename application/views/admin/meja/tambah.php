...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="card card-body">
            <h3 class="box-title m-b-0">Form Tambah Meja</h3>
            <p class="text-muted m-b-30 font-13"> Digunakan untuk menambahkan meja baru</p>
                    ...
                    <?php echo form_open(); ?>
                        <div class="form-group">
                            <?php 
                                ...
                                echo form_input('no_meja','','class="form-control" id="exampleInputEmail1" placeholder="Masukkan nomor meja..."'); 
                            ?>
                        </div>
